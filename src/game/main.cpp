...
int main(int argc, char *argv[]) {
    ...
    std::shared_ptr<Rendering::Shader> shader = std::make_shared<Rendering::Shader>("resources/shaders/fb/framebuffer.vert", "resources/shaders/fb/framebuffer.frag");
    Rendering::FrameBuffer sceneFB = {static_cast<float>(Rendering::Renderer::GetWidth()), static_cast<float>(Rendering::Renderer::GetHeight()), shader};
